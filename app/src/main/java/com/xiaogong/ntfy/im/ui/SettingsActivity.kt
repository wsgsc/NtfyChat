...
class SettingsActivity : AppCompatActivity(), PreferenceFragmentCompat.OnPreferenceStartFragmentCallback,
    ...
    override fun onAddCustomHeader(dialog: DialogFragment, header: com.xiaogong.ntfy.im.db.CustomHeader) {
        lifecycleScope.launch(Dispatchers.IO) {
    ...
    override fun onUpdateCustomHeader(dialog: DialogFragment, oldHeader: com.xiaogong.ntfy.im.db.CustomHeader, newHeader: com.xiaogong.ntfy.im.db.CustomHeader) {
        lifecycleScope.launch(Dispatchers.IO) {
    ...
    override fun onDeleteCustomHeader(dialog: DialogFragment, header: com.xiaogong.ntfy.im.db.CustomHeader) {
        lifecycleScope.launch(Dispatchers.IO) {
