...
class SubscriberService : Service() {
    ...
    private fun onNotificationReceived(subscription: Subscription, notification: com.xiaogong.ntfy.im.db.Notification) {
    ...
    companion object {
        ...
        private const val NOTIFICATION_GROUP_ID = "com.xiaogong.ntfy.im.NOTIFICATION_GROUP_SERVICE"
