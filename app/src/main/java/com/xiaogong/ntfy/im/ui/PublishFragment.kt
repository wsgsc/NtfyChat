...
import com.xiaogong.ntfy.im.util.AfterChangedTextWatcher
import com.xiaogong.ntfy.im.util.formatBytes
import com.xiaogong.ntfy.im.util.mimeTypeToIconResource
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.Job
import kotlinx.coroutines.launch
import kotlinx.coroutines.withContext
import com.xiaogong.ntfy.im.util.ProgressRequestBody
                ...
                val messageToSend = if (subscription?.encryptionEnabled == true) {
                    ...
                    if (encryptPassword.isNullOrEmpty()) {
                        ...
                        withContext(Dispatchers.Main) {
                            ...
                            errorText.text = getString(R.string.publish_dialog_error_no_encryption_password)
                    ...
                    try {
                        ...
                        withContext(Dispatchers.Main) {
                            ...
                            uploadProgress.visibility = View.GONE
                            uploadProgressText.visibility = View.GONE
                            errorText.text = getString(R.string.publish_dialog_error_encryption, e.message)
                            errorText.visibility = View.VISIBLE
                            errorImage.visibility = View.VISIBLE
                            enableView(true)
                        }
